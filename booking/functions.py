...
start_date = datetime.date(2020, 4, 28)  # взять дату начала брони
end_date = datetime.date(2020, 4, 29)  # взять дату конца брони
...
def get_date_array(start_date, end_date):
    ...
    d = [start_date + i * day_delta for i in range((end_date - start_date + day_delta).days)]  # аналогичная функция, хз зачем,
    # может тебе будет удобнее.
    return d
a = get_date_array(start_date, end_date)
print(a)
print(len(a))
print(1200 * len(a))
